...
compile group: 'org.apache.hadoop', name: 'hadoop-mapreduce-client-common', version: '3.2.1'
```
* yarn
```
// https://mvnrepository.com/artifact/org.apache.hadoop/hadoop-yarn-common
compile group: 'org.apache.hadoop', name: 'hadoop-yarn-common', version: '3.2.1'
```
* hive
```
